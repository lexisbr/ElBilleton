    ...
    <section class="contenido">
        <div class="container">
            <div class="centrar">
                ...
                <form action="${pageContext.request.contextPath}/ObtenerCuentaRetiro" class="form-control" method="GET" enctype="multipart/form-data" style="width: 500px; height: 250px; background: #003366;">
