    ...
    <section class="contenido">
        <div class="container">
            <div class="centrar">
                ...
                <form action="${pageContext.request.contextPath}/ObtenerCuentaAsociacion" class="form-control" method="GET" enctype="multipart/form-data" style="width: 500px; height: 250px; background: #003366;">
                    <div class="form-group">
                        <h1 class="subtitulo">Ingresa cuenta</h1>
                        <br>
