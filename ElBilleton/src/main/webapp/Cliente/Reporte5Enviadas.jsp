...
<html>
    ...
    <section class="contenido">
        <form action="ObtenerCuentas" method="GET">
            ...
            <hr>
             <a href="ExportarReporte5Solicitudes?cliente_codigo=${cliente_codigo}" target="_blank" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Exportar</a>
            <br>
            <br>
            <div class="container">
