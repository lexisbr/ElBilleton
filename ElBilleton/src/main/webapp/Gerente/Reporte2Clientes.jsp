            ...
            <div class="container">
                <table class="table table-dark table-bordered" style="font-size: 18px;">
                    <tr>
                        ...
                        <th class="text-center">PDF DPI</th>
                    ...
                    <c:forEach items="${listaClientes}" var="cliente">
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-warning btn-sm" href="${pageContext.request.contextPath}/ObtenerTransaccionesReporte2?codigo=${cliente.getCodigo()}">Mostrar transacciones</a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
