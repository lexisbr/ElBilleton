 ...
 * @author lex
 */
@WebServlet(name = "ObtenerCuentaDeposito", urlPatterns = {"/ObtenerCuentaDeposito"})
public class ObtenerCuentaDeposito extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            try {
                ...
                System.out.println("No hay mensaje "+e);
            }
