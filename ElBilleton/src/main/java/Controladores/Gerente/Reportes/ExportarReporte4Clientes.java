 ...
 * @author lex
 */
@WebServlet(name = "ExportarReporte4Clientes", urlPatterns = {"/ExportarReporte4Clientes"})
public class ExportarReporte4Clientes extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String path = request.getServletContext().getRealPath("/Recursos/Gerente/reporte4.jasper");
