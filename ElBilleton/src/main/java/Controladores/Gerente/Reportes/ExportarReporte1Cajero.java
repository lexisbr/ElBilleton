...
public class ExportarReporte1Cajero extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            parametro.put("cajero_codigo", Long.parseLong(request.getParameter("codigo")));
            String path = request.getServletContext().getRealPath("/Recursos/Gerente/reporteHistorialCajero.jasper");
