 ...
 * @author lex
 */
@WebServlet(name = "ExportarReporte6", urlPatterns = {"/ExportarReporte6"})
public class ExportarReporte6 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String path = request.getServletContext().getRealPath("/Recursos/Gerente/reporte6.jasper");
