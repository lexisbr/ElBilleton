 ...
 * @author lex
 */
@WebServlet(name = "ExportarReporte2Clientes", urlPatterns = {"/ExportarReporte2Clientes"})
public class ExportarReporte2Clientes extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String path = request.getServletContext().getRealPath("/Recursos/Gerente/reporte2.jasper");
