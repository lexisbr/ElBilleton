 ...
 * @author lex
 */
@WebServlet(name = "ExportarReporte5Clientes", urlPatterns = {"/ExportarReporte5Clientes"})
public class ExportarReporte5Clientes extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String path = request.getServletContext().getRealPath("/Recursos/Gerente/reporte5.jasper");
