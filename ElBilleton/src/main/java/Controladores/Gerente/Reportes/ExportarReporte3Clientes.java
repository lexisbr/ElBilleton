 ...
 * @author lex
 */
@WebServlet(name = "ExportarReporte3Clientes", urlPatterns = {"/ExportarReporte3Clientes"})
public class ExportarReporte3Clientes extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            parametro.put("monto", Double.parseDouble(request.getParameter("limite")));
            String path = request.getServletContext().getRealPath("/Recursos/Gerente/reporte3.jasper");
