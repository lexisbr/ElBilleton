 ...
 * @author lex
 */
@WebServlet("/MostrarDPIHistorial")
public class MostrarDPIHistorial extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        try {
            ...
            response.getOutputStream().write(historialCliente.obtenerDPI(codigo).readAllBytes());
