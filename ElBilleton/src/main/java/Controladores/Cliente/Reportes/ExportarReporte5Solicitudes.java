 ...
 * @author lex
 */
@WebServlet(name = "ExportarReporte5Solicitudes", urlPatterns = {"/ExportarReporte5Solicitudes"})
public class ExportarReporte5Solicitudes extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String path = request.getServletContext().getRealPath("/Recursos/Cliente/reporte5enviadas.jasper");
