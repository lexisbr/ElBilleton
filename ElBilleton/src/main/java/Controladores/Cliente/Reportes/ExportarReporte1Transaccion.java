 ...
 * @author lex
 */
@WebServlet(name = "ExportarReporte1Transaccion", urlPatterns = {"/ExportarReporte1Transaccion"})
public class ExportarReporte1Transaccion extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String path = request.getServletContext().getRealPath("/Recursos/Cliente/reporte1.jasper");
