 ...
 * @author lex
 */
@WebServlet(name = "ExportarReporte3Transacciones", urlPatterns = {"/ExportarReporte3Transacciones"})
public class ExportarReporte3Transacciones extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            parametro.put("cuenta_codigo", Long.parseLong(request.getParameter("codigo")));
            parametro.put("fecha1", request.getParameter("fecha1"));
            parametro.put("fecha2", request.getParameter("fecha2"));
            String path = request.getServletContext().getRealPath("/Recursos/Cliente/reporte2Transacciones.jasper");
