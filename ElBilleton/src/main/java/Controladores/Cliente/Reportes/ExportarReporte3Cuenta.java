 ...
 * @author lex
 */
@WebServlet(name = "ExportarReporte3Cuenta", urlPatterns = {"/ExportarReporte3Cuenta"})
public class ExportarReporte3Cuenta extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String path = request.getServletContext().getRealPath("/Recursos/Cliente/reporte2Cliente.jasper");
